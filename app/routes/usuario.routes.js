...
module.exports = function (application) {
    ...
    application.post('/encontrar_usuario', UsuarioController.adicionar_novo_usuario)
    application.post('/modificar_usuario', UsuarioController.adicionar_novo_usuario)
    application.post('/deletar_usuario', UsuarioController.adicionar_novo_usuario)
